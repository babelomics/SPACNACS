const config = Object.freeze({
    opencga: {
        ...
        cnvsUrl: 'http://csvs.clinbioinfosspa.es:8080/prioCNVs/webservices/rest',
        version: "1.3.8"
    },/*
  cellbase: {
    ...
    cnv: {
        ...
        url: "http://csvs.clinbioinfosspa.es:8080/prioCNVs/webservices/rest",
        ...
        igv: {
            ...
            genomes: {
                hg19: {
                    ...
                    fastaURL: "http://csvs.clinbioinfosspa.es/spacnacs/downloads/hg19.fasta",
                    indexURL: "http://csvs.clinbioinfosspa.es/spacnacs/downloads/hg19.fasta.fai",
                    cytobandURL: "http://csvs.clinbioinfosspa.es/spacnacs/downloads/cytoBand.txt",
                    ...
                    tracks: [
                        {
                            ...
                            url: "http://csvs.clinbioinfosspa.es/spacnacs/downloads/cytoBandColor.txt",
                            visibilityWindow: -1,
                            removable: true,
                            order: 1,
...

                        {
                            name: "Refseq Genes",
                            format: "refgene",
                            url: "http://csvs.clinbioinfosspa.es/spacnacs/downloads/refGene.sorted.txt.gz",
                            indexURL: "http://csvs.clinbioinfosspa.es/spacnacs/downloads/refGene.sorted.txt.gz.tbi",
                            visibilityWindow: -1,
                            removable: false,
                            order: 2,
                            displayMode: "COLLAPSED",
                        ...
                        /*{
                            ...
                            id: "legend",
                            type:"annotation",
                            url:"http://csvs.clinbioinfosspa.es/cnvDB/downloads/legend.txt",
                            order: 6,
                            //autoHeight: true,
                            height: 40,
                        ...
                        },*/
                        {
                            ...
                            id: "gnomad",
                            format: "vcf",
                            url:"http://csvs.clinbioinfosspa.es/spacnacs/downloads/gnomad_v2.1_sv.controls_only.sites.filtered.vcf.gz",
                            indexURL: "http://csvs.clinbioinfosspa.es/spacnacs/downloads/gnomad_v2.1_sv.controls_only.sites.filtered.vcf.gz.tbi",
                            visibilityWindow: -1,
                            removable: false,
                            order: 7,
                            autoHeight: true,
...

                        {
                            ...
                            id: "1000GP",
                            format: "vcf",
                            url: "http://csvs.clinbioinfosspa.es/spacnacs/downloads/ALL.wgs.integrated_sv_map_v2.20130502.svs.genotypes.filtered.vcf.gz",
                            indexURL: "http://csvs.clinbioinfosspa.es/spacnacs/downloads/ALL.wgs.integrated_sv_map_v2.20130502.svs.genotypes.filtered.vcf.gz.tbi",
...

                        {
                            ...
                            type: "variant",
                            format: "gff",
                            url: "http://csvs.clinbioinfosspa.es/spacnacs/downloads/homo_sapiens.GRCh37.Regulatory_Build.regulatory_features.20201218.sorted.gff",
                            indexURL: "http://csvs.clinbioinfosspa.es/spacnacs/downloads/homo_sapiens.GRCh37.Regulatory_Build.regulatory_features.20201218.sorted.gff.idx",
                            visibilityWindow: -1,
                            removable: false,
                            order: 11,
                            autoHeight: true,
...

                        {
                            ...
                            url:  "http://csvs.clinbioinfosspa.es/spacnacs/downloads/variant_summary_grch37_dup_del_less1.txt",
                            visibilityWindow: -1,
                            removable: true,
                            order: 14,
                            displayMode: "SQUISHED",
                        ...
                        /* {
                             ...
                             id: "legendClivar",
                             type:"annotation",
                             url: "http://csvs.clinbioinfosspa.es/cnv/downloads/legend.txt",
                             order: 15,
                             //autoHeight: true,
                             height: 70,

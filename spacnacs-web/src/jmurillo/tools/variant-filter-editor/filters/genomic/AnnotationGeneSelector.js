...
class AnnotationGeneSelector extends React.Component {
		...
		return (
			<div style={{paddingTop:"1em"}}>
				...
				<Paper className={classes.textPaper}>
						<InputBase className={classes.textInput} placeholder="Search gene..." value={this.state.searchText}
												...
												<HtmlTooltip title={
													<React.Fragment>
														<ul>
															<li>Gene: {term.id}</li>
                                                            {!!term.description &&
															<li> Synonyms: {term.description}</li>
                                                            }
															<li>Location: {term.chromosome}:{term.start}-{term.end}</li>
														</ul>
													</React.Fragment>}>
...
AnnotationGeneSelector.propTypes = {
...
export default withStyles(styles)(AnnotationGeneSelector);